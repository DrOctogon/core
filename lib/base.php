...
class OC {
	...
	private static function registerEncryptionWrapper() {
		$enabled = self::$server->getConfig()->getSystemValue('encryption_enabled', false);
		if ($enabled) {
			\OC\Files\Filesystem::addStorageWrapper('oc_encryption', function ($mountPoint, $storage) {
				...
				return new \OC\Files\Storage\Wrapper\Encryption(array('storage' => $storage), $manager,$util, $uid);
			});
		}
